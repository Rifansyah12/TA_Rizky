...
<div class="card">
    <div class="card-body">
        ...
        <form method="GET" action="{{ route('cms.ekstrakurikuler.index') }}" class="my-3">
            <div class="input-group">
                <input type="text" name="q" class="form-control" placeholder="Cari ekstrakurikuler..." value="{{ request('q') }}">
                            ...
                            <form method="POST" action="{{ route('cms.ekstrakurikuler.update', $item) }}" enctype="multipart/form-data" class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    @if($item->foto)
                                        ...
                                        <img src="{{ asset('storage/' . $item->foto) }}" width="100"></p>
                                    @endif
